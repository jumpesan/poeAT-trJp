...
import SettingsStashCheck from './stash-check.vue'
import SettingsMapRunTimer from '../map-run-timer/settings-map-run-timer.vue'
  ...
  switch (type) {
    ...
    default:
      return [
        ...
        [SettingsGeneral],
        [SettingsPricecheck, SettingsMaps, SettingsItemcheck, SettingsStashCheck, SettingsMapRunTimer],
