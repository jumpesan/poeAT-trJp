...
export interface StatFilter {
  ...
  //fractured?: boolean // NOTE: additional settings
  fracturedMode?: 'explicit' | 'fractured' | 'both'
  mergeGroup?: number
}
...
export function hasFilterTag (filter: Pick<StatFilter, 'tags'>, tag: FilterTag): boolean {
  return filter.tags.includes(tag)
}

export function hasAnyFilterTag (filter: Pick<StatFilter, 'tags'>, tags: FilterTag[]): boolean {
