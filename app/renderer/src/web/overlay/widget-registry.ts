...
import WidgetMapRunTimer from '../map-run-timer/WidgetMapRunTimer.vue'
import WidgetMapRunStats from '../map-run-stats/WidgetMapRunStats.vue'
import WidgetSnapshotValues from '../snapshot-values/WidgetSnapshotValues.vue'
...
registry.widgets.push(WidgetMapRunTimer as unknown as WidgetComponent)
registry.widgets.push(WidgetMapRunStats as unknown as WidgetComponent)
registry.widgets.push(WidgetSnapshotValues as unknown as WidgetComponent)
