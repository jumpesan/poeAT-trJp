...
export interface MapRunTimerWidget extends Widget {
  anchor: Anchor
}


export interface MapRunStatsWidget extends Widget {
  anchor: Anchor
}

export interface SnapshotValuesWidget extends Widget {
  anchor: Anchor
}
