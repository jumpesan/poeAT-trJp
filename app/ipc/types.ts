...
type IpcPoeLoginOpen =
  Event<'CLIENT->MAIN::poe-login-open'>

type IpcPoeGetCharacters =
  Event<'CLIENT->MAIN::poe-get-characters'>

type IpcPoeCharacters =
  Event<'MAIN->CLIENT::poe-characters', {
    characters: Array<{
      name: string
      league: string
    }>
...
type IpcPoeLoginStatus =
  Event<'CLIENT->MAIN::poe-login-status'> |
  Event<'MAIN->CLIENT::poe-login-status', {
    loggedIn: boolean
  }>
